...
public class OrdersController extends BaseController {
    ...
    public ModelAndView list() {
        ModelAndView view = new ModelAndView("yucai/order/list");
    ...
    public void datagrid(YcOrdersEntity entity, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
        //拼接查询条件
        QueryWrapper<YcOrdersEntity> queryWrapper = QueryUtils.installQueryWrapper(entity, request.getParameterMap(), dataGrid);

        //执行查询
        IPage<YcOrdersEntity> lstResult = ycOrdersService.page(new Page<YcOrdersEntity>(dataGrid.getPage(), dataGrid.getRows()), queryWrapper);
