...
@TableName("yc_insurance_orders")
@Getter
@Setter
public class YcInsuranceOrdersEntity extends BaseEntity {
    ...
    @TableField("BAOXIAN_ORDERS_ID")
    private String baoxianOrdersId;
