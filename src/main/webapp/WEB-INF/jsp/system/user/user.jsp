					...
					<div class="ibox-content">
						<t:formvalid action="sys/user/saveUser">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="userName" name="userName" <c:if test="${not empty user.id }">readonly="readonly"</c:if> minlength="2" maxlength="50" type="text" class="form-control" required="" value="${user.userName }">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">真实姓名*：</label>
                                <div class="col-sm-8">
                                    <input id="realName" name="realName" minlength="2" maxlength="50" type="text" class="form-control" required="" value="${user.realName }">
                                </div>
                            </div>
