...
<body class="gray-bg">
	...
	<!-- 脚本部分 -->
	<t:datagrid actionUrl="func/timer/job/datagrid" tableContentId="jqGrid_wrapper" searchGroupId="searchGroupId" fit="true" caption="定时任务管理" name="table_list_2" pageSize="20"  sortOrder="desc">
